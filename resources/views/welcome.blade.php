                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Call Center Siaga Covid-19</h3>
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">(0355) 320119 - PSC</br>(0355) 321924 - DINKES</br>(0355) 7625000 - DINKES</h2>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1.4s">
                            <img src="assets/images/cs.png" alt="hero">
            ...
            <div class="row justify-content-center">
                <div class="counter-wrapper mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                    <div class="counter-content">
                        ...
                        <p class="text">Data berikut bersifat sementara dan dapat berubah sewaktu-waktu. </br><strong>*(update terakhir 26/3/2020)</strong></p>
                    </div> <!-- counter content -->
