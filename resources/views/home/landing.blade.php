...
<body>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title"><span>Menjaga masyarakat</span> Tulunagagung</h3>
                        </div> <!-- section title -->
                        <p class="text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, seiam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing.</p>
                        <!-- <a href="#" class="main-btn">Try it Free</a> -->
                    </div> <!-- about content -->
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <div class="card service">
                        <div class="card-body">
                            <div class="media"><img src="assets/images/profile.svg" alt="Alfan Jauhari" style="width: 100px; height: 100px; border-radius: 100%;">
                                <div class="media-body ml-4">
                                    <h3 class="mt-0 mb-0 font-weight-bold">Satgas1</h3>
                                    <h5 class=""><a data-v-93cc92b4="" href="tel:0215210411" class="font-weight-bold">021-5210-411</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <div class="card service">
                        <div class="card-body">
                            <div class="media"><img src="assets/images/profile.svg" alt="Muhammad Surya Maulana" style="width: 100px; height: 100px; border-radius: 100%;">
                                <div class="media-body ml-4">
    ...
    <section id="rujukan" class="testimonial-area pt-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="section-title text-center pb-40">
    ...
    <section id="news" class="blog-area pt-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
